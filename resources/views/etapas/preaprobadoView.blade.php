...
<div class="card-body">
    ...
    @endswitch  
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="cdp" value="{{ $etapas ? old('cdp') : $data->cdp}}">
            @if ($errors->has('cdp'))
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" name="fecha_cdp" value="{{ $etapas ? old('fecha_cdp') : $data->fecha_cdp}}">

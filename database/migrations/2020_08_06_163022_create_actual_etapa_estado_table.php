...
class CreateActualEtapaEstadoTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tr_actual_etapa_estado', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tr_actual_etapa_estado');
    }
}

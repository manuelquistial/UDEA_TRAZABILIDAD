        ...
        .then((data) => {
            data.data.forEach(element => {
                ...
                <tr>
                    ...
                    <td class="text-right">${parseInt(element.pp_inicial).toLocaleString('de-DE')}</td>
                    <td class="text-right">${parseInt(element.egreso).toLocaleString('de-DE')}</td>
                    <td class="text-right">${parseInt(element.reserva).toLocaleString('de-DE')}</td>
                    <td class="text-right">${(parseInt(element.pp_inicial) - parseInt(element.egreso) - parseInt(element.reserva)).toLocaleString('de-DE')}</td>
                </tr>
                `
            });
            $('#modal').modal('show')
